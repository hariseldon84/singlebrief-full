...
from app.models.memory import MemoryEmbedding, UserMemory, TeamMemory
    ...
    async def search_similar_memories(
        ...
        try:
            ...
            result = (
                self.client.query
                .get(self.class_name, [
                    "memoryId", "memoryType", "userId", "teamId", 
                    "content", "category", "importanceScore", "createdAt"
                ])
                .with_near_vector({
...
vector_db_manager = VectorDatabaseManager(
    database_type=settings.VECTOR_DATABASE_TYPE
)