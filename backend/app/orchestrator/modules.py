...
class SingleBriefModule(Protocol):
    ...
    async def process_query(self, query: Dict[str, Any], context: Any) -> Dict[str, Any]:
...
class ModuleRegistry:
    ...
    def register_module(
        ...
        try:
            ...
            logger.info(f"Registered module: {module.name} with capabilities: {module.capabilities}")
            return True
