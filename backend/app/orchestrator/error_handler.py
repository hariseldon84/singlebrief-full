...
class ErrorHandler:
    ...
    def _update_failure_tracking(self, error_context: ErrorContext):
        ...
        if error_context.module_name:
            ...
            self.module_failure_counts[module_name] = self.module_failure_counts.get(module_name, 0) + 1
    ...
    async def _handle_module_failure(
        ...
        logger.info(f"Attempting to route around failed module: {error_context.module_name}")
