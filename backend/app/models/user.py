...
class Organization(Base):
    ...
    domain = Column(String(255), unique=True, nullable=True)  # Company domain for auto-assignment
    ...
    decisions: Mapped[List["Decision"]] = relationship("Decision", back_populates="organization")
    user_memories: Mapped[List["UserMemory"]] = relationship("UserMemory", back_populates="organization")
    team_memories: Mapped[List["TeamMemory"]] = relationship("TeamMemory", back_populates="organization")
    ...
    consent_records: Mapped[List["ConsentRecord"]] = relationship("ConsentRecord", back_populates="organization")
    data_access_logs: Mapped[List["DataAccessLog"]] = relationship("DataAccessLog", back_populates="organization")
    privacy_settings: Mapped[List["PrivacySetting"]] = relationship("PrivacySetting", back_populates="organization")
    gdpr_requests: Mapped[List["GDPRRequest"]] = relationship("GDPRRequest", back_populates="organization")
    security_events: Mapped[List["SecurityEvent"]] = relationship("SecurityEvent", back_populates="organization")
...
class Team(Base):
    ...
    # New relationships for core models
    conversations: Mapped[List["Conversation"]] = relationship("Conversation", back_populates="team")
    decisions: Mapped[List["Decision"]] = relationship("Decision", back_populates="team")
    team_memories: Mapped[List["TeamMemory"]] = relationship("TeamMemory", back_populates="team")
...
class User(Base):
    ...
    created_team_memories: Mapped[List["TeamMemory"]] = relationship("TeamMemory", back_populates="created_by")
    
    # Integration relationships
    configured_integrations: Mapped[List["Integration"]] = relationship("Integration", back_populates="configured_by")
    oauth_tokens: Mapped[List["OAuthToken"]] = relationship("OAuthToken", back_populates="user")
    integration_permissions: Mapped[List["IntegrationPermission"]] = relationship("IntegrationPermission", foreign_keys="IntegrationPermission.user_id", back_populates="user")
    integration_logs: Mapped[List["IntegrationLog"]] = relationship("IntegrationLog", back_populates="user")
    
    # Audit and compliance relationships
    audit_logs: Mapped[List["AuditLog"]] = relationship("AuditLog", back_populates="user")
    consent_records: Mapped[List["ConsentRecord"]] = relationship("ConsentRecord", back_populates="user")
    data_access_logs: Mapped[List["DataAccessLog"]] = relationship("DataAccessLog", foreign_keys="DataAccessLog.user_id", back_populates="user")
    privacy_settings: Mapped[List["PrivacySetting"]] = relationship("PrivacySetting", back_populates="user")
    gdpr_requests: Mapped[List["GDPRRequest"]] = relationship("GDPRRequest", foreign_keys="GDPRRequest.user_id", back_populates="user")
    security_events: Mapped[List["SecurityEvent"]] = relationship("SecurityEvent", back_populates="user")
